...
namespace Xero.DotNet.OAuth2.Model.Asset
{
    /// <summary>
    ...
    public partial class FieldValidationErrorsElement :  IEquatable<FieldValidationErrorsElement>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ValueProvided: ").Append(ValueProvided).Append("\n");
        ...
        {
            return this.Equals(input as FieldValidationErrorsElement);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(FieldValidationErrorsElement input)
        {
            if (input == null)
                return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ValueProvided != null)
                    hashCode = hashCode * 59 + this.ValueProvided.GetHashCode();
