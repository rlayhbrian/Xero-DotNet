...
namespace Xero.DotNet.OAuth2.Model.PayrollAu
{
    ...
    /// </summary>
    [DataContract]
    public partial class SettingsTrackingCategoriesTimesheetCategories :  IEquatable<SettingsTrackingCategoriesTimesheetCategories>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as SettingsTrackingCategoriesTimesheetCategories);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(SettingsTrackingCategoriesTimesheetCategories input)
        {
            if (input == null)
                return false;
