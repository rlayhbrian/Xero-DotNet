...
namespace Xero.DotNet.OAuth2.Model.PayrollNz
{
    ...
    /// </summary>
    [DataContract]
    public partial class EarningsOrderObject :  IEquatable<EarningsOrderObject>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as EarningsOrderObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(EarningsOrderObject input)
        {
            if (input == null)
                return false;
