...
namespace Xero.DotNet.OAuth2.Model.PayrollNz
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentMethodObject :  IEquatable<PaymentMethodObject>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as PaymentMethodObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(PaymentMethodObject input)
        {
            if (input == null)
                return false;
