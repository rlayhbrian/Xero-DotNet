...
namespace Xero.DotNet.OAuth2.Model.PayrollNz
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmployeeTaxObject :  IEquatable<EmployeeTaxObject>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name="employeeTax", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EmployeeTax: ").Append(EmployeeTax).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as EmployeeTaxObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(EmployeeTaxObject input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.EmployeeTax == input.EmployeeTax ||
                    (this.EmployeeTax != null &&
                    this.EmployeeTax.Equals(input.EmployeeTax))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EmployeeTax != null)
                    hashCode = hashCode * 59 + this.EmployeeTax.GetHashCode();
                return hashCode;
            }
        }
