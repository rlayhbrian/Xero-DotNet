...
namespace Xero.DotNet.OAuth2.Model.PayrollNz
{
    ...
    /// </summary>
    [DataContract]
    public partial class Reimbursements :  IEquatable<Reimbursements>, IValidatableObject
    {
        ...
        public List<Reimbursement> _Reimbursements { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _Reimbursements: ").Append(_Reimbursements).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as Reimbursements);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(Reimbursements input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this._Reimbursements == input._Reimbursements ||
                    this._Reimbursements != null &&
                    input._Reimbursements != null &&
                    this._Reimbursements.SequenceEqual(input._Reimbursements)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this._Reimbursements != null)
                    hashCode = hashCode * 59 + this._Reimbursements.GetHashCode();
                return hashCode;
            }
        }
