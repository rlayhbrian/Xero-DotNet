...
namespace Xero.DotNet.OAuth2.Model.PayrollNz
{
    ...
    /// </summary>
    [DataContract]
    public partial class Superannuations :  IEquatable<Superannuations>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as Superannuations);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(Superannuations input)
        {
            if (input == null)
                return false;
