...
namespace Xero.DotNet.OAuth2.Model.PayrollNz
{
    ...
    /// </summary>
    [DataContract]
    public partial class SalaryAndWageObject :  IEquatable<SalaryAndWageObject>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SalaryAndWages: ").Append(SalaryAndWages).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as SalaryAndWageObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(SalaryAndWageObject input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SalaryAndWages == input.SalaryAndWages ||
                    (this.SalaryAndWages != null &&
                    this.SalaryAndWages.Equals(input.SalaryAndWages))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SalaryAndWages != null)
                    hashCode = hashCode * 59 + this.SalaryAndWages.GetHashCode();
                return hashCode;
            }
        }
