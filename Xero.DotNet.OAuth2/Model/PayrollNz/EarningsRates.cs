...
namespace Xero.DotNet.OAuth2.Model.PayrollNz
{
    ...
    /// </summary>
    [DataContract]
    public partial class EarningsRates :  IEquatable<EarningsRates>, IValidatableObject
    {
        ...
        public List<EarningsRate> _EarningsRates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _EarningsRates: ").Append(_EarningsRates).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as EarningsRates);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(EarningsRates input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this._EarningsRates == input._EarningsRates ||
                    this._EarningsRates != null &&
                    input._EarningsRates != null &&
                    this._EarningsRates.SequenceEqual(input._EarningsRates)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this._EarningsRates != null)
                    hashCode = hashCode * 59 + this._EarningsRates.GetHashCode();
                return hashCode;
            }
        }
