...
namespace Xero.DotNet.OAuth2.Model.PayrollNz
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReimbursementObject :  IEquatable<ReimbursementObject>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ReimbursementObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ReimbursementObject input)
        {
            if (input == null)
                return false;
