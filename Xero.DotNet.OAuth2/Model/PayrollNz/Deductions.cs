...
namespace Xero.DotNet.OAuth2.Model.PayrollNz
{
    ...
    /// </summary>
    [DataContract]
    public partial class Deductions :  IEquatable<Deductions>, IValidatableObject
    {
        ...
        public List<Deduction> _Deductions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _Deductions: ").Append(_Deductions).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(Deductions input)
        {
            ...
            return 
                ...
                (
                    this._Deductions == input._Deductions ||
                    this._Deductions != null &&
                    input._Deductions != null &&
                    this._Deductions.SequenceEqual(input._Deductions)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this._Deductions != null)
                    hashCode = hashCode * 59 + this._Deductions.GetHashCode();
                return hashCode;
            }
        }
