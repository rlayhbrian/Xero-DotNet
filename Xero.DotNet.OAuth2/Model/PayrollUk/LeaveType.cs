...
namespace Xero.DotNet.OAuth2.Model.PayrollUk
{
    ...
    public partial class LeaveType :  IEquatable<LeaveType>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IsStatutoryLeave: ").Append(IsStatutoryLeave).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(LeaveType input)
        {
            ...
            return 
                ...
                (
                    ...
                    this.IsStatutoryLeave.Equals(input.IsStatutoryLeave))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsStatutoryLeave != null)
                    hashCode = hashCode * 59 + this.IsStatutoryLeave.GetHashCode();
                return hashCode;
            }
        }
