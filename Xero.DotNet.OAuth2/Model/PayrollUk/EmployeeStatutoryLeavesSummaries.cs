...
namespace Xero.DotNet.OAuth2.Model.PayrollUk
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmployeeStatutoryLeavesSummaries :  IEquatable<EmployeeStatutoryLeavesSummaries>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name="statutoryLeaves", EmitDefaultValue=false)]
        public List<EmployeeStatutoryLeaveSummary> StatutoryLeaves { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  StatutoryLeaves: ").Append(StatutoryLeaves).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as EmployeeStatutoryLeavesSummaries);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(EmployeeStatutoryLeavesSummaries input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.StatutoryLeaves == input.StatutoryLeaves ||
                    this.StatutoryLeaves != null &&
                    input.StatutoryLeaves != null &&
                    this.StatutoryLeaves.SequenceEqual(input.StatutoryLeaves)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.StatutoryLeaves != null)
                    hashCode = hashCode * 59 + this.StatutoryLeaves.GetHashCode();
                return hashCode;
            }
        }
