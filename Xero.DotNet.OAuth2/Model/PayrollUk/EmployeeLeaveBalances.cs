...
namespace Xero.DotNet.OAuth2.Model.PayrollUk
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmployeeLeaveBalances :  IEquatable<EmployeeLeaveBalances>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as EmployeeLeaveBalances);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(EmployeeLeaveBalances input)
        {
            if (input == null)
                return false;
