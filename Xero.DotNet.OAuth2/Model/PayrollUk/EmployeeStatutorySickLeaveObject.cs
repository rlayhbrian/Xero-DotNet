...
namespace Xero.DotNet.OAuth2.Model.PayrollUk
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmployeeStatutorySickLeaveObject :  IEquatable<EmployeeStatutorySickLeaveObject>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as EmployeeStatutorySickLeaveObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(EmployeeStatutorySickLeaveObject input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.StatutorySickLeave.Equals(input.StatutorySickLeave))
                );
        }
