...
namespace Xero.DotNet.OAuth2.Model.PayrollUk
{
    ...
    public partial class Settings :  IEquatable<Settings>, IValidatableObject
    {
        ...
        public Accounts _Settings { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _Settings: ").Append(_Settings).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(Settings input)
        {
            ...
            return 
                ...
                (
                    this._Settings == input._Settings ||
                    (this._Settings != null &&
                    this._Settings.Equals(input._Settings))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this._Settings != null)
                    hashCode = hashCode * 59 + this._Settings.GetHashCode();
                return hashCode;
            }
        }
