...
namespace Xero.DotNet.OAuth2.Model.PayrollUk
{
    ...
    /// </summary>
    [DataContract]
    public partial class EarningsRateObject :  IEquatable<EarningsRateObject>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name="earningsRate", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EarningsRate: ").Append(EarningsRate).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as EarningsRateObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(EarningsRateObject input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.EarningsRate == input.EarningsRate ||
                    (this.EarningsRate != null &&
                    this.EarningsRate.Equals(input.EarningsRate))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EarningsRate != null)
                    hashCode = hashCode * 59 + this.EarningsRate.GetHashCode();
                return hashCode;
            }
        }
