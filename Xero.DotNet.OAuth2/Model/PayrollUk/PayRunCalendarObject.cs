...
namespace Xero.DotNet.OAuth2.Model.PayrollUk
{
    ...
    /// </summary>
    [DataContract]
    public partial class PayRunCalendarObject :  IEquatable<PayRunCalendarObject>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name="payRunCalendar", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PayRunCalendar: ").Append(PayRunCalendar).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as PayRunCalendarObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(PayRunCalendarObject input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PayRunCalendar == input.PayRunCalendar ||
                    (this.PayRunCalendar != null &&
                    this.PayRunCalendar.Equals(input.PayRunCalendar))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PayRunCalendar != null)
                    hashCode = hashCode * 59 + this.PayRunCalendar.GetHashCode();
                return hashCode;
            }
        }
