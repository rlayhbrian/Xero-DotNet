...
namespace Xero.DotNet.OAuth2.Model.PayrollUk
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmployeeStatutoryLeaveBalanceObject :  IEquatable<EmployeeStatutoryLeaveBalanceObject>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name="leaveBalance", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LeaveBalance: ").Append(LeaveBalance).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as EmployeeStatutoryLeaveBalanceObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(EmployeeStatutoryLeaveBalanceObject input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.LeaveBalance == input.LeaveBalance ||
                    (this.LeaveBalance != null &&
                    this.LeaveBalance.Equals(input.LeaveBalance))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LeaveBalance != null)
                    hashCode = hashCode * 59 + this.LeaveBalance.GetHashCode();
                return hashCode;
            }
        }
