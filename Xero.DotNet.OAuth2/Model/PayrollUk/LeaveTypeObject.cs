...
namespace Xero.DotNet.OAuth2.Model.PayrollUk
{
    ...
    /// </summary>
    [DataContract]
    public partial class LeaveTypeObject :  IEquatable<LeaveTypeObject>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as LeaveTypeObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(LeaveTypeObject input)
        {
            if (input == null)
                return false;
