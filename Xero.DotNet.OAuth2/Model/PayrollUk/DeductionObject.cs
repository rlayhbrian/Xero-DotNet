...
namespace Xero.DotNet.OAuth2.Model.PayrollUk
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeductionObject :  IEquatable<DeductionObject>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as DeductionObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(DeductionObject input)
        {
            if (input == null)
                return false;
