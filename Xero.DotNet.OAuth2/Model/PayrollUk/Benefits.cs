...
namespace Xero.DotNet.OAuth2.Model.PayrollUk
{
    ...
    public partial class Benefits :  IEquatable<Benefits>, IValidatableObject
    {
        ...
        public List<Benefit> _Benefits { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _Benefits: ").Append(_Benefits).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(Benefits input)
        {
            ...
            return 
                ...
                (
                    this._Benefits == input._Benefits ||
                    this._Benefits != null &&
                    input._Benefits != null &&
                    this._Benefits.SequenceEqual(input._Benefits)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this._Benefits != null)
                    hashCode = hashCode * 59 + this._Benefits.GetHashCode();
                return hashCode;
            }
        }
