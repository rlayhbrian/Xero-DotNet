...
namespace Xero.DotNet.OAuth2.Model.PayrollUk
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmploymentObject :  IEquatable<EmploymentObject>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as EmploymentObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(EmploymentObject input)
        {
            if (input == null)
                return false;
