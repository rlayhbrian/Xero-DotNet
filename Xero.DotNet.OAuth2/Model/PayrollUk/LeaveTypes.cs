...
namespace Xero.DotNet.OAuth2.Model.PayrollUk
{
    ...
    /// </summary>
    [DataContract]
    public partial class LeaveTypes :  IEquatable<LeaveTypes>, IValidatableObject
    {
        ...
        public List<LeaveType> _LeaveTypes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _LeaveTypes: ").Append(_LeaveTypes).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as LeaveTypes);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(LeaveTypes input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this._LeaveTypes == input._LeaveTypes ||
                    this._LeaveTypes != null &&
                    input._LeaveTypes != null &&
                    this._LeaveTypes.SequenceEqual(input._LeaveTypes)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this._LeaveTypes != null)
                    hashCode = hashCode * 59 + this._LeaveTypes.GetHashCode();
                return hashCode;
            }
        }
