...
namespace Xero.DotNet.OAuth2.Model.Accounting
{
    ...
    /// </summary>
    [DataContract]
    public partial class Actions :  IEquatable<Actions>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _Actions: ").Append(_Actions).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(Actions input)
        {
            ...
            return 
                (
                    this._Actions == input._Actions ||
                    this._Actions != null &&
                    input._Actions != null &&
                    this._Actions.SequenceEqual(input._Actions)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this._Actions != null)
                    hashCode = hashCode * 59 + this._Actions.GetHashCode();
                return hashCode;
            }
        }
