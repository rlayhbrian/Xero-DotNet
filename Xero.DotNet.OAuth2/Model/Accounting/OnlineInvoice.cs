...
namespace Xero.DotNet.OAuth2.Model.Accounting
{
    ...
    public partial class OnlineInvoice :  IEquatable<OnlineInvoice>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OnlineInvoiceUrl: ").Append(OnlineInvoiceUrl).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as OnlineInvoice);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(OnlineInvoice input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    ...
                    this.OnlineInvoiceUrl.Equals(input.OnlineInvoiceUrl))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.OnlineInvoiceUrl != null)
                    hashCode = hashCode * 59 + this.OnlineInvoiceUrl.GetHashCode();
                return hashCode;
            }
        }
