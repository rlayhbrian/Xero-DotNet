...
namespace Xero.DotNet.OAuth2.Model.Accounting
{
    ...
    public partial class Budgets :  IEquatable<Budgets>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _Budgets: ").Append(_Budgets).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as Budgets);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(Budgets input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    ...
                    this._Budgets != null &&
                    input._Budgets != null &&
                    this._Budgets.SequenceEqual(input._Budgets)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this._Budgets != null)
                    hashCode = hashCode * 59 + this._Budgets.GetHashCode();
                return hashCode;
            }
        }
