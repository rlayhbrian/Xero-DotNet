...
namespace Xero.DotNet.OAuth2.Model.Accounting
{
    ...
    public partial class BrandingThemes :  IEquatable<BrandingThemes>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _BrandingThemes: ").Append(_BrandingThemes).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as BrandingThemes);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(BrandingThemes input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    ...
                    input._BrandingThemes != null &&
                    this._BrandingThemes.SequenceEqual(input._BrandingThemes)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this._BrandingThemes != null)
                    hashCode = hashCode * 59 + this._BrandingThemes.GetHashCode();
                return hashCode;
            }
        }
