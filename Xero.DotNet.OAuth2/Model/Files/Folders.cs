...
namespace Xero.DotNet.OAuth2.Model.Files
{
    /// <summary>
    /// Folders
    /// </summary>
    ...
    public partial class Folders :  IEquatable<Folders>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _Folders: ").Append(_Folders).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as Folders);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(Folders input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    ...
                    this._Folders != null &&
                    input._Folders != null &&
                    this._Folders.SequenceEqual(input._Folders)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this._Folders != null)
                    hashCode = hashCode * 59 + this._Folders.GetHashCode();
                return hashCode;
            }
        }
