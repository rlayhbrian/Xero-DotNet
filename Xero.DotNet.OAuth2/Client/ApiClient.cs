...
[assembly: System.Runtime.CompilerServices.InternalsVisibleToAttribute("Xero.DotNet.OAuth2.Test")]
namespace Xero.DotNet.OAuth2.Client
{
    ...
    internal class CustomJsonCodec : IRestSerializer, ISerializer, IDeserializer
    {
        ...
        public string Serialize(object obj)
        {
            ...
            if (obj.GetType().FullName.Contains(@"Xero.DotNet.OAuth2.Model.Accounting") || obj.GetType().FullName.Contains(@"Xero.DotNet.OAuth2.Model.PayrollAu") )
            {
    ...
    public partial class ApiClient : ISynchronousClient, IAsynchronousClient
    {
        ...
        public ApiClient()
        {
            _baseUrl = Xero.DotNet.OAuth2.Client.GlobalConfiguration.Instance.BasePath;
        }
