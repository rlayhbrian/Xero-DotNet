...
using Xero.DotNet.OAuth2.Model.Identity;
    ...
    public partial class IdentityApi : IIdentityApi
    {
        ...
        public IdentityApi() : this((string) null)
        {
            this.Configuration = Xero.DotNet.OAuth2.Client.Configuration.MergeConfigurations(
                ...
                new Xero.DotNet.OAuth2.Client.Configuration { BasePath = "https://api.xero.com" }
            );
        ...
        /// <returns></returns>
        public IdentityApi(Xero.DotNet.OAuth2.Client.Configuration configuration)
        {
        ...
        public IdentityApi(Xero.DotNet.OAuth2.Client.ISynchronousClient client,Xero.DotNet.OAuth2.Client.IAsynchronousClient asyncClient, Xero.DotNet.OAuth2.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Xero.DotNet.OAuth2.Client.ApiResponse<Object>> DeleteConnectionAsyncWithHttpInfo (string accessToken, Guid id, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Xero.DotNet.OAuth2.Client.ApiException(400, "Missing required parameter 'id' when calling IdentityApi->DeleteConnection");
        ...
        {
             Xero.DotNet.OAuth2.Client.ApiResponse<List<Connection>> localVarResponse = await GetConnectionsAsyncWithHttpInfo(accessToken, authEventId, cancellationToken);
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of ApiResponse (List&lt;Connection&gt;)</returns>
        public async System.Threading.Tasks.Task<Xero.DotNet.OAuth2.Client.ApiResponse<List<Connection>>> GetConnectionsAsyncWithHttpInfo (string accessToken, Guid? authEventId = null, CancellationToken cancellationToken = default)
        {
            ...
            if (authEventId != null)
            {
                foreach (var kvp in Xero.DotNet.OAuth2.Client.ClientUtils.ParameterToMultiMap("", "authEventId", authEventId))
                {
