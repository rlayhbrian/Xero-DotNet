...
using Xero.DotNet.OAuth2.Model.Accounting;
using Xunit.Abstractions;

[assembly: CollectionBehavior(DisableTestParallelization = true)]
namespace Xero.DotNet.OAuth2.Test.Api.Accounting
{
  /// <summary>
  ...
  public class AccountingApiTests : IAsyncLifetime
  {
    ...
    private const string accessToken = "XeroDotNetTestAccessToken";

    private const string xeroTenantId = "XeroDotNetTestTenantId";
    ...
    public async Task InitializeAsync()
    {
      ...
      var config = new Xero.DotNet.OAuth2.Client.Configuration();
