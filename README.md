...
After NetStandard and NetCore's EOL announcement, we have migrated our SDKs to Net8 to keep it up to date.
...
The Xero-DotNet SDK makes it easy for developers to access Xero's APIs in their Csharp code, and build robust applications and software using small business & general ledger accounting data.
...
[`Xero.DotNet.OAuth2`](https://www.nuget.org/packages/Xero.DotNet.OAuth2/) contains code to call all the XeroAPI endpoints

![OAuth2 Endpoints](https://img.shields.io/nuget/v/Xero.DotNet.OAuth2)
![dotnet Downloads](https://img.shields.io/nuget/dt/Xero.DotNet.OAuth2)

[`Xero.DotNet.OAuth2Client`](https://www.nuget.org/packages/Xero.DotNet.OAuth2Client/) code to authenticate and manage tokens

![OAuth2Client](https://img.shields.io/nuget/v/Xero.DotNet.OAuth2Client)
![dotnet Downloads](https://img.shields.io/nuget/dt/Xero.DotNet.OAuth2Client)

[OAuth2Client README](https://github.com/XeroAPI/dotnet/tree/master/Xero.DotNet.OAuth2Client)

---
Use Nuget to download the packages via command line:
```
dotnet add package Xero.DotNet.OAuth2
dotnet add package Xero.DotNet.OAuth2Client
```
Or use the Package Manager Console inside Visual Studio
```
Install-Package Xero.DotNet.OAuth2
Install-Package Xero.DotNet.OAuth2Client
```
You can also download the source code from https://github.com/XeroAPI/Xero-DotNet and compile it by yourself.
